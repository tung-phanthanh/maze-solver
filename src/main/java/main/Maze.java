...
public class Maze {
    ...
    public static final int W = 5; //kích thước 1 ô

    public static int speed = 1;
    public static boolean generated, solved;

    private static final String[] GENERATION_METHODS = {"1. Prim's Generation", "2. Kruskal's Generation",
            "3. Binary Tree Generation", "4. DFS Generation"};
    private static final String[] SOLVING_METHODS = {"1. BFS", "2. DFS", "3. Bi-directional DFS",
            "4. Dijkstra's", "5. A Star", "6. Bi-directional A Star", "7. Wall Follower"};
